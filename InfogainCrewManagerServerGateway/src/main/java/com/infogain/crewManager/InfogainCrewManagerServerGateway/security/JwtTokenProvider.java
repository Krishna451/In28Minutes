...
import com.infogain.crewManager.InfogainCrewManagerServerGateway.repository.JwtTokenRepository;
...
public class JwtTokenProvider {
    ...
    private String secretKey="infogain";
    ...
    public String createToken(String username, List<String> roles) {
        ...
        String token =  Jwts.builder()//
                ...
                .compact();
        System.out.println("before save token method");
        jwtTokenRepository.save(new JwtToken(token));
        System.out.println("after save token method");
        return token;
    }
